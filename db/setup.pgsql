...
insert into tb_table (field) values ('{"id_system":1,"name":"tb_system","id_type":1,"title":"Sistemas","id_parent":9}');
insert into tb_table (field) values ('{"id_system":1,"name":"tb_table","id_type":1,"title":"Tabelas","id_parent":9}');
insert into tb_table (field) values ('{"id_system":1,"name":"tb_field","id_type":1,"title":"Campos","id_parent":9}');
insert into tb_table (field) values ('{"id_system":1,"name":"tb_domain","id_type":1,"title":"Domínios","id_parent":9}');
insert into tb_table (field) values ('{"id_system":1,"name":"tb_event","id_type":1,"title":"Eventos","id_parent":9}');
insert into tb_table (field) values ('{"id_system":1,"name":"tb_action","id_type":1,"title":"Ações","id_parent":9}');
...
insert into tb_field (field) values ('{"id_system":1,"id_table":3,"label":"Campo Fk","name":"id_field_fk","id_type":1,"size":0,"mask":"","id_mandatory":2,"id_unique":2,"id_table_fk":3,"id_field_fk":11,"domain":""}');
...
insert into tb_field (field) values ('{"id_system":1,"id_table":5,"label":"Campo","name":"id_field","id_type":1,"size":0,"mask":"","id_mandatory":2,"id_unique":1,"id_table_fk":3,"id_field_fk":11,"domain":""}');
...
insert into tb_domain (field) values ('{"id_system":1,"key":"3","value":"Menu","domain":"tb_table_type"}');
-- tb_bool
...
insert into tb_event (field) values ('{"id_system":1,"id_target":2,"id_table":3,"id_field":17,"id_action":0,"id_event":3,"code":"cascade(this.value, ''id_table_fk'', ''id_field_fk'')"}');
-- tb_domain
...
insert into tb_event (field) values ('{"id_system":1,"id_target":2,"id_table":5,"id_field":24,"id_action":0,"id_event":3,"code":"cascade(this.value, ''id_table'', ''id_field'')"}');
-- tb_action
