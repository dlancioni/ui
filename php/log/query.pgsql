...
, (tb_view_field.field->>'ordenation')::int as ordenation
 from tb_view_field
 inner join tb_domain tb_command_id_command on (tb_view_field.field->>'id_command')::text = (tb_command_id_command.field->>'key')::text and (tb_command_id_command.field->>'domain')::text = 'tb_command'
