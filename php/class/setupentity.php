    ...
    class SetupEntity extends Setup {
        ...
        private function createModule($cn) {
            ...
            try {
                ...
                $moduleId = $this->execute($cn, $model->addModule("tb_entity", "Pessoas", $this->MODULE_USER, $this->MENU_CAD));
                ...
                // MODULES [ADDRESS]    
                $this->setModule("tb_module");
                $moduleId = $this->execute($cn, $model->addModule("tb_address", "Endereços", $this->MODULE_USER, $this->MENU_CAD));
                ...
                // MODULES [DOCTOS]
                $this->setModule("tb_module");
                $moduleId = $this->execute($cn, $model->addModule("tb_document", "Documentos", $this->MODULE_USER, $this->MENU_CAD));
                ...
                // MODULES [CONTACT]
                $this->setModule("tb_module");
                $moduleId = $this->execute($cn, $model->addModule("tb_contact", "Contatos", $this->MODULE_USER, $this->MENU_CAD));
